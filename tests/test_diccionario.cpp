...
TEST(diccionario, dicc_string_bool) {
    ...
    ASSERT_FALSE(d.def("Pato"));
    d.definir("Pato", true);
    ASSERT_TRUE(d.def("Pato"));
    ASSERT_FALSE(d.def("Gato"));
    ASSERT_EQ(d.obtener("Pato"), true);
    d.definir("Gato", false);
    ASSERT_TRUE(d.def("Gato"));
    ASSERT_EQ(d.obtener("Pato"), true);
    ASSERT_EQ(d.obtener("Gato"), false);
    d.definir("Perro", true);
    ASSERT_TRUE(d.def("Perro"));
    ASSERT_EQ(d.obtener("Perro"), true);
}
#endif
